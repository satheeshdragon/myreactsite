  ...
  render() {
    return (
      <div>
        ...
        <Col xs lg="6">           
            <button class=" text-center loginBtn loginBtn--facebook" onClick={this.handleFacebook}>
              Login with Facebook
            </button>
        ...
        <Col xs lg="6">           
            ...
            <button class=" text-center loginBtn loginBtn--google" onClick={this.handleGoogle}>
              Login with Google
            </button>
        </Col>
        </Row>
